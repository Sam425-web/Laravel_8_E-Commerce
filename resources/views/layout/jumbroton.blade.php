<div class="jumbotron card card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg);">
  <div class="text-white text-center py-5 px-4">
    <div>
      <h2 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>P&S E-Commerce </strong></h2>
      ...
      <a href="{{ route('shop') }}" class="btn btn-outline-dark btn-md"><i class="fas fa-clone left"></i> Go to SHOP!</a>
    </div>
  </div>
</div>